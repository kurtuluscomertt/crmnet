...
$sorgu = $conn->query("SELECT baslik,aciklama,buton_aciklama,buton_url,img FROM slider");

$cikti = $sorgu->fetch(PDO::FETCH_ASSOC);

//----------------------------------------

$sorgu1 = $conn->query("SELECT baslik,aciklama,buton_aciklama,buton_url,img FROM bolum1");
...
$sorgu2 = $conn->query("SELECT baslik,aciklama,buton_aciklama,buton_url,kart1_icon,kart1_aciklama,kart2_icon,kart2_aciklama,kart3_icon,kart3_aciklama,kart4_icon,kart4_aciklama FROM bolum2");
                    ...
                    <div class="row">
                        <div class="col-xl-7 col-lg-6 col-md-8 col-sm-10">
                            <div class="hero__caption">
                                <h1 data-animation="fadeInUp" data-delay=".4s"><?php echo$cikti["baslik"] ?></h1>
                                <P data-animation="fadeInUp" data-delay=".6s" ><?php echo$cikti["aciklama"] ?></P>
                                <!-- Hero-btn -->
                                <div class="hero__btn">
                                    <a href="<?php echo$cikti["buton_url"] ?>" class="btn hero-btn mb-10"  data-animation="fadeInUp" data-delay=".8s"><?php echo$cikti["buton_aciklama"] ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-xl-6 col-lg-6 col-md-10">
                    <div class="about-caption mb-50">
                        ...
                        <p><?php echo$cikti1["aciklama"] ?></p>
                    </div>
                    <a href="<?php echo$cikti1["buton_url"] ?>" class="btn"><?php echo$cikti1["buton_aciklama"] ?></a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row justify-content-between">
                <div class="col-lg-6 col-md-9">
                    ...
                    <div class="section-tittle section-tittle2 mb-50">
                        <h2 class="mb-35"><?php echo$cikti2["baslik"] ?></h2>
                        <p><?php echo$cikti2["aciklama"] ?></p>
                        <a href="<?php echo$cikti2["buton_url"] ?>" class="btn  mt-30"><?php echo$cikti2["buton_aciklama"] ?></a>
                    </div>
                </div>
                <div class="col-lg-5">
                   <div class="row">
                       <div class="col-lg-6 col-md-4 col-sm-6">
                            <div class="single-services mb-30 text-center">
                                <i class="<?php echo$cikti2["kart1_icon"] ?>"></i>
                                <p><?php echo$cikti2["kart1_aciklama"] ?></p>
                            </div>
                       </div>
                       <div class="col-lg-6 col-md-4 col-sm-6">
                            <div class="single-services mb-30 text-center">
                                <i class="<?php echo$cikti2["kart2_icon"] ?>"></i>
                                <p><?php echo$cikti2["kart2_aciklama"] ?></p>
                            </div>
                       </div>
                       <div class="col-lg-6 col-md-4 col-sm-6">
                            <div class="single-services mb-30 text-center">
                                <i class="<?php echo$cikti2["kart3_icon"] ?>"></i>
                                <p><?php echo$cikti2["kart3_aciklama"] ?></p>
                            </div>
                       </div>
                       <div class="col-lg-6 col-md-4 col-sm-6">
                            <div class="single-services mb-30 text-center">
                                <i class="<?php echo$cikti2["kart4_icon"] ?>"></i>
                                <p><?php echo$cikti2["kart4_aciklama"] ?></p>
                            </div>
                       </div>
                   </div>
                </div>
