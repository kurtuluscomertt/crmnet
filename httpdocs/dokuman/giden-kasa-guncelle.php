...
<head>
  ...
  <title>Giden Kasa Güncelle</title>
        ...
        <div class="col-md-6 col-12">
            <div class="card">
			 ...
			 foreach($personellist as $person){?>
                    <form class="form form-horizontal" action="/islemler/kasa-giden-guncelle-2.php?pid=<?= $person->id ?>" method="post">
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                <div class="form-group has-icon-left">
                                    <div class="position-relative">
                                        <input type="text" class="form-control" value="<?= $person->isim ?>" name="isim" id="first-name-icon" >
