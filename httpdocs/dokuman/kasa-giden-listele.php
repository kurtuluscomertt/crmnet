...
$sorgu=$db->prepare('SELECT *FROM kasa_giden');
$sorgu->execute();
...
<head>
    ...
    <title>Kasa Giden Listele</title>
...
<body>
 ...
 <?php   require("header.php"); ?>
			 ...
			 foreach($personellist as $person){?>
                ...
                <td><a href="./islemler/giden-odeme-sil.php?pid=<?= $person->id ?>"  class="btn btn-danger">Sil</a></td>
                 <td><a href="/giden-kasa-guncelle.php?pid=<?= $person->id ?>"  class="btn btn-info">Güncelle</a></td>
