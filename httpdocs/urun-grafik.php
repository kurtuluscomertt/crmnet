...
$sorgu1->execute();
$personellist1=$sorgu1-> fetchAll(PDO::FETCH_OBJ);
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="col-12">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="alert alert-primary">
                                        ...
                                        <a href="https://choices.org/getting-started/installation" target="_blank">En fazla</a> 10 adet ürün seçebilirsiniz
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <h6>Ürün Seçimi</h6>
			 ...
			 foreach($personellist1 as $person1){?> <option value="<?= $person1->stok_adi ?>" ><?= $person1->stok_adi ?></option>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <p> <code>Seçimleri aşağıdan yapabilirsiniz</code></p>
                                    <div class="form-group">
                                    <select class="form-select" id="basicSelect" name="urun3">
                                    <option value=" "></option>
                                                    <?php
			 foreach($personellist1 as $person1){?> <option value="<?= $person1->stok_adi ?>" ><?= $person1->stok_adi ?></option>
                                                        <?php } ?>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <p> <code>Seçimleri aşağıdan yapabilirsiniz</code></p>
                                    <div class="form-group">
                                    <select class="form-select" id="basicSelect" name="urun4">
                                    <option value=" "></option>
                                                    <?php
			 foreach($personellist1 as $person1){?> <option value="<?= $person1->stok_adi ?>" ><?= $person1->stok_adi ?></option>
                                                        <?php } ?>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <p> <code>Seçimleri aşağıdan yapabilirsiniz</code></p>
                                    <div class="form-group">
                                    <select class="form-select" id="basicSelect" name="urun5">
                                    <option value=" "></option>
                                                    <?php
			 foreach($personellist1 as $person1){?> <option value="<?= $person1->stok_adi ?>" ><?= $person1->stok_adi ?></option>
                                                        <?php } ?>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <p> <code>Seçimleri aşağıdan yapabilirsiniz</code></p>
                                    <div class="form-group">
                                    <select class="form-select" id="basicSelect" name="urun6">
                                    <option value=" "></option>
                                                    <?php
			 foreach($personellist1 as $person1){?> <option value="<?= $person1->stok_adi ?>" ><?= $person1->stok_adi ?></option>
                                                        <?php } ?>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <p> <code>Seçimleri aşağıdan yapabilirsiniz</code></p>
                                    <div class="form-group">
                                    <select class="form-select" id="basicSelect" name="urun7">
                                    <option value=" "></option>
                                                    <?php
			 foreach($personellist1 as $person1){?> <option value="<?= $person1->stok_adi ?>" ><?= $person1->stok_adi ?></option>
                                                        <?php } ?>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <p> <code>Seçimleri aşağıdan yapabilirsiniz</code></p>
                                    <div class="form-group">
                                    <select class="form-select" id="basicSelect" name="urun8">
                                    <option value=" "></option>
                                                    <?php
			 foreach($personellist1 as $person1){?> <option value="<?= $person1->stok_adi ?>" ><?= $person1->stok_adi ?></option>
                                                        <?php } ?>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <p> <code>Seçimleri aşağıdan yapabilirsiniz</code></p>
                                    <div class="form-group">
                                    <select class="form-select" id="basicSelect" name="urun9">
                                    <option value=" "></option>
                                                    <?php
			 foreach($personellist1 as $person1){?> <option value="<?= $person1->stok_adi ?>" ><?= $person1->stok_adi ?></option>
                                                        <?php } ?>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <p> <code>Seçimleri aşağıdan yapabilirsiniz</code></p>
                                    <div class="form-group">
                                    <select class="form-select" id="basicSelect" name="urun10">
                                    <option value=" "></option>
                                                    <?php
			 foreach($personellist1 as $person1){?> <option value="<?= $person1->stok_adi ?>" ><?= $person1->stok_adi ?></option>
                                                        <?php } ?>
