...
<body>
 ...
 <?php   require("header.php"); ?>
			 ...
			 foreach($personellist as $person){?>
                 ...
                 <td><?= $person->adres?></td>
			 	<td><a href="/islemler/musteri-sil.php?pid=<?= $person->id ?>"  class="btn btn-danger">Sil</a></td>
                 <td><a href="/musteri-guncelle.php?pid=<?= $person->id ?>"  class="btn btn-info">Güncelle</a></td>
